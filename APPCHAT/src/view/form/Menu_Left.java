...
public class Menu_Left extends JPanel{
	...
	public Menu_Left() {
		...
		panel_menu.add(bt_setting, "width 52:52:52,grow");
		...
		bt_chat2P.setIcon(new ImageIcon(Menu_Left.class.getResource("/images/icon/Messages-icon.png")));
		bt_chatGroup.setIcon(new ImageIcon(Menu_Left.class.getResource("/images/icon/Group-icon.png")));
		bt_setting.setIcon(new ImageIcon(Menu_Left.class.getResource("/images/icon/Info-icon.png")));
