...
public class Chat_Title extends JPanel{
	...
	public Chat_Title() {
		...
		bt_member.setIcon(new ImageIcon(Chat_Title.class.getResource("/images/icon/human.png")));
		bt_member.setForeground(Color.BLUE);
		bt_member.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Service.getInstance().getMain().getHome().getChat().memberGroup();
			}
		});
		bt_member.setFont(new Font("Berlin Sans FB Demi", Font.BOLD, 20));
		bt_member.setVisible(false);
		
		bt_add = new JButton("New group");
		bt_add.setIcon(new ImageIcon(Chat_Title.class.getResource("/images/icon/group.png")));
		bt_add.setForeground(Color.BLUE);
		bt_add.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				newGroup();
			}
		});
		bt_add.setFont(new Font("Berlin Sans FB Demi", Font.BOLD, 20));
		...
		layout.setHorizontalGroup(
			layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
					...
					.addGap(20)
					.addComponent(bt_member, GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE)
					.addGap(13)
					.addComponent(bt_add, GroupLayout.PREFERRED_SIZE, 175, GroupLayout.PREFERRED_SIZE)
			...
			layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
					.addGroup(layout.createParallelGroup(Alignment.LEADING)
						.addComponent(layer, GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
						.addGroup(layout.createSequentialGroup()
							.addGap(10)
							.addGroup(layout.createParallelGroup(Alignment.BASELINE)
								.addComponent(bt_add, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(bt_member, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE))
							.addGap(10)))
					.addContainerGap())
		);
